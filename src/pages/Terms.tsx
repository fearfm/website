...
export const Terms: React.FC = () => (
    <CenterColumn>
        ...
        <p>These terms and conditions outline the rules and regulations for the use of Fear.FM&apos;s Website, located
            at
            https://fear.fm.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Fear.FM if
            ...
            created with the help of the <a href="https://www.termsandconditionsgenerator.com">Terms And Conditions
                Generator</a> and the <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">Free
        ...
        <p>We employ the use of cookies. By accessing Fear.FM, you agreed to use cookies in agreement with the
            Fear.FM&apos;s
            Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, Fear.FM and/or its licensors own the intellectual property rights for all material
            on Fear.FM. All intellectual property rights are reserved. You may access this from Fear.FM for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from Fear.FM</li>
            <li>Sell, rent or sub-license material from Fear.FM</li>
            <li>Reproduce, duplicate or copy material from Fear.FM</li>
            <li>Redistribute content from Fear.FM</li>
        </ul>

        <p>This Agreement shall begin on the date hereof.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Fear.FM does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of Fear.FM,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, Fear.FM shall not be liable for the Comments or for any liability, damages or
        ...
        <p>Fear.FM reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Fear.FM a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Fear.FM; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Fear.FM. Please include your name, your organization name,
        ...
        <p>No use of Fear.FM&apos;s logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
