    ...
    <AppBar className={classes.root}>
      <Toolbar>
        ...
        <Typography className={classes.socialIcons}>
          { location.pathname !== '/' && (
            <MiniControls size='10'/>
          )}
          <Tooltip title="Fear.FM on Facebook" aria-label="Facebook">
            <a href="https://www.facebook.com/Fear.FM/" target="_blank" rel="noopener noreferrer">
              <IconFacebook className={classes.icon} />
            </a>
          </Tooltip>
          <Tooltip title="Fear.FM on Instagram">
            <a href="https://www.instagram.com/fearfmofficial" target="_blank" rel="noopener noreferrer">
