  ...
  return (
    ...
    >
      <Grid item xs={12} md={8}>
        ...
        <p>At Fear.FM, accessible from https://www.fear.fm, one of our main priorities is the privacy of our visitors. This
        Privacy Policy document contains types of information that is collected and recorded by Fear.FM and how we use
      it.</p>
      ...
      us.</p>
        ...
        to the information that they shared and/or collect in Fear.FM. This policy is not applicable to any information
      ...
      name, address, email address, and telephone number.</p>
        ...
        <h2>Log Files</h2>
        <p>Fear.FM follows a standard procedure of using log files. These files log visitors when they visit websites. All
        ...
        users&apos; movement on the website, and gathering demographic information. Our Privacy Policy was created with
      the help of the <a href="https://www.privacypolicygenerator.info">Privacy Policy Generator</a> and the <a
            href="https://www.disclaimergenerator.org/">Disclaimer Generator</a>.</p>

        <h2>Cookies and Web Beacons</h2>
        <p>Like any other website, Fear.FM uses &apos;cookies&apos;. These cookies are used to store information including
      ...
      following URL – <a
        ...
        their respective advertisements and links that appear on Fear.FM, which are sent directly to users&apos; browser.
      ...
      websites that you visit.</p>
        ...
        <p>Fear.FM&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
      ...
      guardians to observe, participate in, and/or monitor and guide their online activity.</p>
        <p>Fear.FM does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
