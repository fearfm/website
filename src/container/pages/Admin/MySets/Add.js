        ...
        <Grid container className={classes.root}>
          ...
          <Grid item xs={5}>
            <TextField
              ...
              helperText={errors[setArtistIdentifier] && errors[setArtistIdentifier].message}
            />
          </Grid>
          <Grid item xs={5}>
            <TextField
              ...
              helperText={errors[setTitleIdentifier] && errors[setTitleIdentifier].message}
            />
          </Grid>
          <Grid item xs={2} />
          <Grid item xs={10}>
            <TextField
              ...
              helperText={errors[setReferenceIdentifier] && errors[setReferenceIdentifier].message}
            />
          </Grid>
          {formFieldTemplate}
        </Grid>
