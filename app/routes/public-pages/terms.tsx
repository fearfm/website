...
export default function Terms() {
  return (<div>
      ...
      <p>
        ...
        Fear.FM&apos;s Website, located at https://fear.fm.
      </p>
      <p>
        By accessing this website we assume you accept these terms and conditions.
        Do not continue to use Fear.FM if you do not agree to take all of the terms
        and conditions stated on this page. Our Terms and Conditions were created
        with the help of the <a href="https://www.termsandconditionsgenerator.com">
      ...
      <h2>Cookies</h2>
      <p>
        We employ the use of cookies. By accessing Fear.FM, you agreed to use
        cookies in agreement with the Fear.FM&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <h2>License</h2>
      <p>
        Unless otherwise stated, Fear.FM and/or its licensors own the intellectual
        property rights for all material on Fear.FM. All intellectual property
        rights are reserved. You may access this from Fear.FM for your own personal
      ...
      <p>
        ...
        opinions and information in certain areas of the website. Fear.FM does not
        filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of Fear.FM,its
        ...
        applicable laws, Fear.FM shall not be liable for the Comments or for any
      ...
      <p>
        Fear.FM reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Fear.FM a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        compensates the absence of Fear.FM; and (d) the link is in the context of
      ...
      <p>
        ...
        e-mail to Fear.FM. Please include your name, your organization name,
      ...
      <p>
        No use of Fear.FM&apos;s logo or other artwork will be allowed for linking
