...
export function Privacy() {
  return (<>
      ...
      <p>
        ...
        of information that is collected and recorded by Fear.FM and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        and/or collect in Fear.FM. This policy is not applicable to any information
      ...
      <h2>Log Files</h2>
      <p>
        Fear.FM follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Fear.FM uses &apos;cookies&apos;. These cookies are
      ...
      <p>
        ...
        advertising partners of Fear.FM.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective advertisements
        and links that appear on Fear.FM, which are sent directly to users&apos;
      ...
      <p>
        Note that Fear.FM has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>

      <h2>Third Party Privacy Policies</h2>
      <p>
        Fear.FM&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Fear.FM does not knowingly collect any Personal Identifiable Information
