    ...
    return (
      <div className={"flex flex-col"}>
        ...
        <div className={"flex h-full flex-col justify-center items-center"}>
          <h1
            className={
              "text-xl px-2 mt-3 mb-2 text-white break-words line-clamp-2"
            }
          >
            {nowplaying.title}
          </h1>
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <span className={"text-xs bg-slate-800 rounded-md px-2 py-1"}>
        ...
        <div className={"flex items-center mt-4 gap-4"}>
          ...
          >
            ...
            <Tooltip.Root delayDuration={0} open={volumeTooltipOpen}>
